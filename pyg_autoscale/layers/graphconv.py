...
class MaskGCNConv(GCNConv):
    ...
    def __init__(self, in_channels: int, out_channels: int, normalize: Optional[bool]=None):
        
        super().__init__(in_channels=in_channels, out_channels=out_channels, normalize=normalize)
